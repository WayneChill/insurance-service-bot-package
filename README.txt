...
銷售                     銷售追蹤列表
增員                     增員追蹤列表
新增準客戶 姓名 電話 階段  階段：已聯繫/建議書/約簽約
新增準增員 姓名 電話 階段  階段：已聯繫/約聊聊/約報聘
...
目前版本：v1.2.0（2026/03/29 發布）

更新內容：
v1.2.0 - 名稱調整（2026/03/29）
  → 「業務追蹤」全面更名為「銷售追蹤」
  → 指令「業務」改為「銷售」
  → 指令「新增業務」改為「新增準客戶」
  → 指令「新增增員」改為「新增準增員」
...
v1.1.0 - 介面與顯示優化（2026/03/29）
  → 所有卡片字體全面放大，方便老花或年長使用者閱讀
  → 保服案件卡片改以「姓名 · 服務項目」為主要顯示，案件ID縮至次要位置
  → 產險卡片按鈕全面換用亮色系（報價藍、延後黃橘、不續保紅、續保完成綠）
  → 產險保單號碼過長時自動換行，不再被截斷
  → 壽險卡片字體與其他卡片拉齊
  → 客戶查詢卡片修正「要保人」標籤寬度，確保完整顯示
  → 早報業務區移除「送保單」項目
  → 早報增員區「約簽約」更正為「約報聘」
  → 增員追蹤階段統一為：已聯繫 / 約聊聊 / 約報聘 / 已結案
